        ...
        if (choice == null) {
            ...
            switch (choice) {
                ...
                case "Number Of Aces":
                    ...
                    int aAceScore = strategy.calculateScore(aHand); //make aAceScore calculate based on number of cards in hand

                    this.aScoreLabel.setText(String.valueOf(aAceScore));
                    break;
                default:
